	...
	<div class="offpage">
		<div class="wrap">
			<div class="wrap_in">
				...
				<div class="title">سایت به دلیل زیر از دسترس خارج است:</div>
				<div class="reason">{reason}</div>
			</div>
		</div>
		<div class="footer">
			<p class="copyleft">
				CopyRight © 2006&ndash;2020 <a href="http://datalifeengine.ir/" target="_blank" rel="nofollow"><b>Datalife Engine Farsi</b></a> All Rights Reserved.
			</p>
		</div>
	</div>
</body>
