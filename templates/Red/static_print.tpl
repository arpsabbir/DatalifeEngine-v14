...
<head>
	...
	<style>
		body { margin: 4% 8%; font: 300 18px/1.5 Georgia, "Times New Roman", Tahoma, sans-serif; background-color: #fff; color: #000; direction:rtl; }
	...
	<title>نسخه چاپی > {description}</title>
</head>
<body>
	<div class="top"><a href="/">خانه</a> / [full-link]{description}[/full-link]</div>
